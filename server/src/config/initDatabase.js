...
const initDatabase = async () => {
  try {
    ...
    const { Role, User, OtpVerification, Room, RoomImage, Facility, RentalRequest, Payment, Contract, ViewingSchedule, Complaint, Conversation, Message, Notification, defineAssociations } = require('../models');
